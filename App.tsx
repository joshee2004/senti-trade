    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-gray-800 text-gray-100 flex flex-col items-center p-4 sm:p-8 selection:bg-blue-500 selection:text-white">
            ...
            <main className="w-full max-w-2xl">
                ...
                {!isLoading &&
                    error &&
                    !predictionData && ( // General error if API call itself failed hard before returning any structure
                ...
                {!isLoading && !predictionData && !error && !currentTicker && (
                    <div className="mt-12 p-8 bg-gray-800/70 rounded-lg shadow-xl text-center border-2 border-dashed border-gray-700">
                        ...
                        <p className="text-gray-400">
                            Enter a stock ticker symbol above to get its
                            sentiment analysis and short-term trend prediction.
                        </p>
                    </div>
                )}
            </main>
            ...
            <footer className="text-center py-8 mt-auto">
                ...
                <p className="text-xs text-gray-600 mt-1">
                    Disclaimer: This tool provides predictions based on AI
                    analysis and should not be considered financial advice.
                    Always do your own research before making investment
                    decisions.
                </p>
            </footer>
        </div>
